  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mt-5
      ...
      .col-lg-4(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema2/15.png" data-aos="fade-left")
    ...
    .row.mt-5
      .col-lg-5.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema2/17.svg" data-aos="fade-right")
      .col-lg-7(style="place-self:center;")
    ...
    .row.mt-5.p-lg-5.p-4(style="background-color:#E3F4FF;")
      .col-lg-5.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema2/18.svg" data-aos="fade-right")
      .col-lg-7(style="place-self:center;")
    ...
    .row.mt-5
      .col-lg-5.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema2/22.svg" data-aos="fade-right")
      .col-lg-7(style="place-self:center;")
    ...
    .row.mt-5
      ...
      .col-lg-5(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema2/23.svg" data-aos="fade-left")
